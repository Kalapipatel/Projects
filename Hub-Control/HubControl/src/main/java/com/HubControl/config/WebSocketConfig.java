...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        ...
        // Allowed origins set to your React Frontend URL
        registry.addEndpoint("/ws")
        //        .setAllowedOrigins("http://localhost:5173", "http://localhost:3000") // Adjust port if your React app runs elsewhere
                .setAllowedOriginPatterns("*") // Adjust port if your React app runs elsewhere
                .withSockJS();
    }
}