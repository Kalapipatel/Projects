...
import { addStore, updateStore } from '../../../services/adminService'; // Corrected path
...
const StoreModal = ({ isOpen, onClose, onSuccess, storeToEdit = null }) => {
  ...
  const handleChange = (e) => {
    ...
    setFormData(prev => ({
      ...prev,
      // Handle boolean conversion for select dropdown
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        // Error logging is handled in service
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-colors"
            />
          </div>
          <div>
