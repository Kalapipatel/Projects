      ...
      <div className="flex flex-col md:flex-row items-center gap-12">
        <div className="md:w-1/2">
          ...
          <div className="space-y-6">
            <RoleItem icon={Users} color="blue" title="Store Managers" desc="Oversee live operations, manage shifts, approve stock transfers, and view real-time KPIs." />
            <RoleItem icon={Package} color="green" title="Pickers & Packers" desc="Mobile-first interface with large buttons, barcode scanning, and clear bin locations." />
            <RoleItem icon={Activity} color="purple" title="HQ Admins" desc="Global view of all dark stores. Master catalog management and supplier relationships." />
          </div>
        </div>
        <div className="md:w-1/2">
