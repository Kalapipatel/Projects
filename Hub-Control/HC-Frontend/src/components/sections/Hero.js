...
const Hero = ({ onNavigate }) => (
  <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
    {/* Background Decorations - Adjusted opacity for dark mode */}
    ...
    <div className="container mx-auto px-4 relative z-10">
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          <div className="inline-flex items-center gap-2 bg-white dark:bg-slate-900 px-4 py-2 rounded-full shadow-sm border border-slate-200 dark:border-slate-800 mb-6">
          ...
          <h1 className="text-5xl lg:text-7xl font-extrabold text-slate-900 dark:text-white leading-tight mb-6 tracking-tight">
            The OS for <span className="text-blue-600 dark:text-blue-500">Dark Stores</span> & Micro-Fulfillment.
          </h1>
          ...
          <div className="mt-10 flex items-center justify-center lg:justify-start gap-6 text-slate-400 dark:text-slate-500">
        ...
        {/* Right Content - Dashboard Mockup (Already using dark colors, just tweaking borders) */}
        <div className="lg:w-1/2 w-full">
          <div className="relative bg-slate-900 rounded-2xl p-2 shadow-2xl transform rotate-1 hover:rotate-0 transition-transform duration-500 border border-slate-800">
            {/* ... Content stays same as it is meant to look like a dark UI ... */}
...
//     <div className="absolute top-0 right-0 w-1/3 h-full bg-blue-100/30 skew-x-12 transform origin-top translate-x-32 pointer-events-none"></div>
//     <div className="absolute bottom-0 left-0 w-64 h-64 bg-orange-100/40 rounded-full filter blur-3xl pointer-events-none"></div>
